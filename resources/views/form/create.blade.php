...
<div class=cadastrar>
  ...
  <form class="validacao" novalidate="">
    <div class="1">
      ...
      <div class="11">
        <x-input name="email" :label="['text' => 'E-mail']" type="email" placeholder="voce@email.com" />
      </div>

      <div class="11">
        <x-input name="logradouro" :label="['text' => 'Logradouro']" placeholder="Rua dos codigos, 1010" />
      </div>

      <div class="11">
        <x-select class="blocodeselecao" name="estado" :label="['text' => 'Estado']" :options="['Selecione..', 'Pernambuco']" />
      </div>

      <div class="11">
        <x-select class="blocodeselecao" name="pais" :label="['text' => 'Pais']" :options="['Selecione...', 'Brasil']" />
      </div>
